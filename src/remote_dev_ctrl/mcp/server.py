...
Exposes browser context tools (list, get, capture) via MCP protocol.
Knowledge, skills, and tools are managed separately by dotai.
"""
...
RDC_SERVER_URL = os.environ.get("RDC_SERVER_URL", "http://127.0.0.1:8420")
